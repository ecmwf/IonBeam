...
Run it with `ionbeam-legacy-api -c config.yaml` (serves on port 8080 by default). New integrations should use the web API or Flight instead — see [Using the Data](../docs/using-the-data.rst).
