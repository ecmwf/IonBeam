...
)  # We pivot locally to offload computation away from influxdb - TODO look into this, is it really any quicker?
...
class InfluxDBTimeSeriesDatabase(TimeSeriesDatabase):
    ...
    async def query_measurement_data(
        ...
        while start < end_time:
            ...
            df_or_list = await query_api.query_data_frame(
                query=flux, use_extension_dtypes=True
            )
