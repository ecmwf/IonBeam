...
- **Dataset building** — queries the window from the timeseries store, assembles Arrow RecordBatches into the arrow store, and notifies subscribed exporters

State lives in InfluxDB 3 (timeseries), Valkey (coordination) and the arrow store; the service itself runs replicated.
